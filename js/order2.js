         ...
         // alert(tr.find(".tqty").val());
          if (isNaN(qty.val())){
               ...
               //  var price = (bprice + ( - ttax2 + ttax)) +100 ;
                   ...
                   var amt = parseInt(qty.val() * bprice);
         ...
         // alert(tr.find(".tqty").val());
          if (isNaN(price.val())){
             ...
             price.val();
                  ...
                  //  var qty = bqty;
                 // console.log('price:'+price);
 var amt = parseInt(bprice * tr.find(".qty").val());
                   //console.log('total:'+amt);
                    tr.find(".amt").html(amt);
...
////@azom air tax
       ...
       var vendor_paid = parseInt(ttax2) + parseInt(tr.find(".tax").val(0));
                 // console.log('total:'+amt);
          ...
          if (isNaN(tax.val())){
             ...
             tax.val();
              ...
              var bprice = parseInt(tr.find(".price").val());
                   ...
                   //var tax = taxaa;
                 // console.log('price:'+price);
            var vendor_paid = parseInt(ttax2) + 100 + parseInt(tr.find(".tax").val()) + (bprice + parseInt(tr.find(".tax").val(0)))*0.003 ;
                 // console.log('total:'+amt);
                    tr.find(".vendor_paid").html(vendor_paid);
//var tax=taxaa;
               }
    ...
    $("#invoice_item").delegate(".tax","keyup",function(){
       ...
       // alert(tr.find(".tqty").val());
          if (isNaN(tax.val())){
             ...
             tax.val();
               ...
               if (tr.find(".gst").val()){
                ...
                var ttax = bprice * ( 1- tr.find(".gst").val()/100);
                   ...
                   //var tax = taxaa;
                 // console.log('price:'+price);
            var grosse_f =  parseInt(bprice * tr.find(".qty").val()) + parseInt(tr.find(".tax").val(0));
             tr.find(".grosse_f").html(grosse_f);
             
            var amt = parseInt(ttax) + parseInt(tr.find(".tax").val(0))+ (bprice + parseInt(tr.find(".tax").val(0)))*0.003 + 100 ;
                 // console.log('total:'+amt);
                    tr.find(".amt").html(amt);
            ...
            var amt = parseInt(bprice * tr.find(".qty").val()) + parseInt(tr.find(".tax").val(0));
                 // console.log('total:'+amt);
                    tr.find(".amt").html(amt);
