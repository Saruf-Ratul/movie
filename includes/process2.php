	...
	?>
	 ...
	 <tr>
		...
		<td><input type="text" id = "ti_no" name = "ti_no" class="form-control form-control-sm" placeholder="Tic/Pax"/required></td>
		 ...
		 <td><input type="text" id = "air" name = "air[]" readonly class="form-control form-control-sm air" placeholder="airlines"/required></td>
		    <td><!-- <input type="text" id = "fly_d" name = "fly_d[]" class="form-control form-control-sm fly_d" placeholder="d/m/y"/required> -->
                 	<input type="text" class="form-control form_date "  id = "fly_d" name= 'fly_d[]' readonly class="controls input-append date form_date" data-date=""  data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd" value= ''/>
				...
				<!--<td>-->
 			<!--	<input  name="gst[]" type="text" readonly class="form-control form-control-sm gst" required/></td>-->
 			<!--	<td>-->
 			<!--	<input  name="gst2[]" type="text" readonly class="form-control form-control-sm gst2" value="0" ></td>-->

				<!--	   <td>-->
    <!--            <input type="text" name= "tax[]" readonly class="form-control form-control-sm tax" value="0"> </td>-->
