...
if (isset($_POST["getNewOrderItem"])){
	...
	?>
	 <tr>
		...
		<td>
			      <select name="pid[]" readonly class="form-control form-control-sm pid" required>
				...
				<td><input name="price[]" type="text" class="form-control form-control-sm price" required> </td>
					   ...
					   <td>
                <input type="text" name= "tax[]" class="form-control form-control-sm tax" required> </td>
                 ...
                 <td>
                 	<span class="vendor_paid"> </span></td>
